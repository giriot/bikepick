...
export interface CompareOpt { id: string; label: string; price: number | null }

/** The full side-by-side comparison — shared by /compare?ids=… and the
 *  indexable /compare/[slug] permalink pages. */
export function ComparisonView({ entities, picker, ids, title, crumbs, weights = DEFAULT_WEIGHTS }: {
